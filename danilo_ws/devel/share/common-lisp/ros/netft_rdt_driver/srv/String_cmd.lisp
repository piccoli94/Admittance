...
(cl:defmethod cl:initialize-instance :after ((m <String_cmd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'String_cmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name netft_rdt_driver-srv:<String_cmd-request> is deprecated: use netft_rdt_driver-srv:String_cmd-request instead.")))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <String_cmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader netft_rdt_driver-srv:cmd-val is deprecated.  Use netft_rdt_driver-srv:cmd instead.")
  (cmd m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<String_cmd-request>)))
  ...
  "netft_rdt_driver/String_cmdRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'String_cmd-request)))
  "Returns string type for a service object of type 'String_cmd-request"
  "netft_rdt_driver/String_cmdRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <String_cmd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'String_cmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name netft_rdt_driver-srv:<String_cmd-response> is deprecated: use netft_rdt_driver-srv:String_cmd-response instead.")))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <String_cmd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader netft_rdt_driver-srv:res-val is deprecated.  Use netft_rdt_driver-srv:res instead.")
  (res m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<String_cmd-response>)))
  ...
  "netft_rdt_driver/String_cmdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'String_cmd-response)))
  "Returns string type for a service object of type 'String_cmd-response"
  "netft_rdt_driver/String_cmdResponse")
